...
def import_train_configuration(config_file):
    ...
    config['n_cars_generated_1'] = content['simulation'].getint('n_cars_generated_1')
    config['n_cars_generated_2'] = content['simulation'].getint('n_cars_generated_2')
    config['n_cars_generated_3'] = content['simulation'].getint('n_cars_generated_3')
    config['n_cars_generated_4'] = content['simulation'].getint('n_cars_generated_4')
    config['n_cars_generated_5'] = content['simulation'].getint('n_cars_generated_5')
