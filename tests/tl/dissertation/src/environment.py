...
from src.trafficSignal import TrafficSignal
...
class SumoEnvironment(MultiAgentEnv):
    ...
    def __init__(self, net_file, route_file, out_csv_name=None, use_gui=False, num_seconds=20000, max_depart_delay=100000,
        ...
        traci.start([self._sumo_binary, '-n', self._net])  # start only to retrieve information
    ...
    def step(self, action):
        ...
        if action is None or action == {}:
            # run simulation for self.delta_time steps
